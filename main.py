...
def main():
    ...
    parser.add_argument("--tone", choices=["formal", "humorous"], default="formal", help="Tone of the brochure")
    parser.add_argument("--translate", choices=["de", "none"], default="none", help="Translate brochure to another language")
    ...
    if args.save:
        ...
        with open(filename, "w", encoding="utf-8") as f:
            f.write(brochure)
        logging.info(f"Brochure saved to {filename}")
